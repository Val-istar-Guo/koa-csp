...
var effectiveAttrValidator = function (obj, effectAttrNames, onError) {
...
function validatorPolicy(policy) {
  if (Object.keys(policy).length === 0) {
    warn('⚠️CSP CONFIG WARNING: Empty Policy');
  }

  effectiveAttrValidator(policy, effectiveAttr, (invalidAttrs) => {
    warn(`⚠️CSP CONFIG WARNING: Invalid Policy Name[${invalidAttrs.join(', ')}]`);
  });
}
 ...
 */
var csp = function ({ enableWarn, policy = {} } = defaultParams) {
